            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        finalimage = im0.copy()
                        plot_one_box(xyxy, finalimage, label=label, color=colors[int(cls)], line_thickness=1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights2', nargs='+', type=str, default='topbottom.pt', help='model.pt path(s)')
